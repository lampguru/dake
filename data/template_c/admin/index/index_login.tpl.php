<?php  if (!defined("IS_INITPHP")) exit("Access Denied!");  /* INITPHP Version 1.0 ,Create on 2012-03-07 09:51:12, compiled from /var/www/initapp/web/template/admin/index/index_login.htm */ ?>
...
<div style="margin-top:10%; margin-left:37%; width:450px; height:250px; padding:15px; border:4px #990000 solid; background:url('static/images/admin/0300.jpg') repeat scroll 0 0 transparent;">
  <div style="width:100%; text-align:center; font-size:24px; font-weight:bold; height:30px; margin-bottom:30px;">initApp&nbsp;&nbsp;管&nbsp;&nbsp;理&nbsp;&nbsp;后&nbsp;&nbsp;台&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
