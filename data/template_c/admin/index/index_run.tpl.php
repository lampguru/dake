<?php  if (!defined("IS_INITPHP")) exit("Access Denied!");  /* INITPHP Version 1.0 ,Create on 2012-03-12 09:30:39, compiled from /var/www/initapp/web/template/admin/index/index_run.htm */ ?>
...
<div class="warp">
  <div class="header">
    <div class="logo">InitApp管理后台</div>
    <div class="banner">
      <ul id="nav">
