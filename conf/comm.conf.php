<?php
/* 应用配置 */
define('ADMIN_FILE', 'admin.php'); //定义后台入口文件admin.php 可以修改
...
$InitPHP_conf['controller']['default_module']        = 'admin'; //默认执行module
$InitPHP_conf['controller']['module_list']           = array('admin'); //默认执行module
 ...
 * 5. 详细见文档
 */
$InitPHP_conf['db_type']                        = 0; //0-单个服务器，1-读写分离，2-随机
$InitPHP_conf['db'][0]['driver']                = 'mysql'; //mysql,mysqli 默认必填
$InitPHP_conf['db'][0]['host']                  = 'localhost'; //主机
$InitPHP_conf['db'][0]['username']              = 'root'; //数据库用户名
$InitPHP_conf['db'][0]['password']              = ''; //数据库密码
$InitPHP_conf['db'][0]['database']              = 'initapp'; //数据库
$InitPHP_conf['db'][0]['charset']               = 'utf8'; //数据库编码   
$InitPHP_conf['db'][0]['pconnect']              = 0; //是否持久链接
